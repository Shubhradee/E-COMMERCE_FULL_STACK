    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6 m-auto bg-white font-monospace shadow border border-info mt-5">
                <h4 class="text-warning text-center fs-10 fw-bold my-3"><b>USER LOGIN</b></h4>
                <form action="login2.php" method="post">
                    ...
                    <input type="password" class="form-control" name="UserPass" id="id_password" required placeholder="Enter your password">
